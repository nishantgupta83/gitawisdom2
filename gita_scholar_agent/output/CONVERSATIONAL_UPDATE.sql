-- ============================================================================
-- CONVERSATIONAL ACTION STEPS UPDATE
-- ============================================================================
...
UPDATE scenarios
SET sc_action_steps = '["Eat before/bring your own dish, writing this down to make it concrete and actionable", "Focus on company not menu, breaking this down into specific, manageable actions", "Relax rules occasionally, committing to this even when it feels uncomfortable", "See food as one part of health, noticing when old patterns emerge and course-correcting", "Seek help if anxiety grows, making this a regular practice you revisit over time"]'::jsonb
...
UPDATE scenarios
SET sc_action_steps = '["Eat beforehand or bring dish, writing this down to make it concrete and actionable", "Focus on people not menu, reaching out to at least 2-3 people who genuinely support you", "Relax rules occasionally, committing to this even when it feels uncomfortable", "See food as part of whole health, noticing when old patterns emerge and course-correcting", "Seek help if anxiety rises, making this a regular practice you revisit over time"]'::jsonb
WHERE scenario_id = 810;

-- Scenario 797: Diet Judged in the Workplace
UPDATE scenarios
SET sc_action_steps = '["Prepare responses to comments, writing this down to make it concrete and actionable", "Eat with supportive peers, breaking this down into specific, manageable actions", "Educate when possible, committing to this even when it feels uncomfortable", "Ignore persistent negativity, noticing when old patterns emerge and course-correcting", "Stay consistent, making this a regular practice you revisit over time"]'::jsonb
WHERE scenario_id = 797;

-- Scenario 839: Hiding Eating Habits to Avoid Judgment
UPDATE scenarios
SET sc_action_steps = '["Identify one safe sharer, writing this down to make it concrete and actionable", "Discuss without apology, breaking this down into specific, manageable actions", "Invite them to meal, committing to this even when it feels uncomfortable", "Accept differing views, noticing when old patterns emerge and course-correcting", "Keep connection strong, reaching out to at least 2-3 people who genuinely support you"]'::jsonb
WHERE scenario_id = 839;

-- Scenario 832: Judging Others’ Food Choices
UPDATE scenarios
SET sc_action_steps = '["Keep focus on own plate, writing this down to make it concrete and actionable", "Avoid food policing, breaking this down into specific, manageable actions", "Compliment variety, committing to this even when it feels uncomfortable", "Invite without pressure, noticing when old patterns emerge and course-correcting", "Support autonomy, making this a regular practice you revisit over time"]'::jsonb
WHERE scenario_id = 832;

-- Scenario 851: Fear of Buffets Due to Spillage Anxiety
UPDATE scenarios
SET sc_action_steps = '["Use smaller plates, writing this down to make it concrete and actionable", "Queue at quieter times, breaking this down into specific, manageable actions", "Ask for help serving, committing to this even when it feels uncomfortable", "Laugh off small mishaps, noticing when old patterns emerge and course-correcting", "Enjoy variety offered, making this a regular practice you revisit over time"]'::jsonb
